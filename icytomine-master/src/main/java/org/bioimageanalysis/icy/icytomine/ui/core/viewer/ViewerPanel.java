...
public class ViewerPanel extends JPanel
{
    ...
    private void buildToolBar()
    {
        ...
        zoomLevelComboBox.setPreferredSize(new Dimension(120, 20));
        zoomLevelComboBox.setMaximumSize(new Dimension(200, 32767));
        zoomLevelComboBox
                .setModel(new DefaultComboBoxModel<String>(new String[] {"1X", "2X", "4X", "10X", "20X", "40X"}));
        ...
        annotationsIcon = ResourceUtil.ICON_ROI_POLYGON.getScaledInstance(20, 20, Image.SCALE_SMOOTH);
        refreshIcon = ResourceUtil.ICON_RELOAD.getScaledInstance(20, 20, Image.SCALE_SMOOTH);
    ...
    private void buildStatusBar()
    {
        ...
        statusIcon.setIcon(new ImageIcon(ResourceUtil.ICON_DATABASE.getScaledInstance(16, 16, Image.SCALE_SMOOTH)));
