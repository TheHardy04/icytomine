...
public class CytomineImageLoop extends Loop
{
    ...
    private List<AbstractAnnotation> currentTileAnnotations;
    ...
    private void importCurrentTile()
    {
        ...
        if (loadAnnotations)
        {
            ...
            currentTileAnnotations =
                    new ArrayList<>(targetImageInstance.getAbstractAnnotationsAt(adjustedCurrentTileArea).values());
    ...
    private void setCurrentTileSequence(BufferedImage tileImage)
    {
        ...
        currentTileSequence
                .setName(targetImageInstance.getName().orElse("Imported_image") + "_" + currentTileArea.getX()
