...
public class CytomineAnnotationTiler extends Loop
{
    ...
    {
        annotationVar = VarCytomineAbstractAnnotation.ofNullable(null);
    ...
    {
        Geometry annotationGeometry = annotation.getGeometryAtZeroResolution(false);
        ...
        annotationShape = shapeWriter.toShape(annotationGeometry);
    }
